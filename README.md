...
All taken from the live guest demo, so this is exactly what you get on
**Continue as guest** — the five sample places, none of them with an uploaded
photo, which is why every card falls back to a map of where the place is.

<div align="center">
  <img src="screenshots/places-list.png" width="200" alt="Places list, each card falling back to a map"/>
  <img src="screenshots/ai-search.png" width="200" alt="Natural-language search returning SFMOMA for the query art"/>
  <img src="screenshots/place-detail.png" width="200" alt="Place detail with rating, tags and notes"/>
  <img src="screenshots/place-det-ai.png" width="200" alt="Smart Summary generated by Gemini from the notes"/>
</div>

<div align="center">
  <img src="screenshots/add-place.png" width="200" alt="Add a place, with AI-suggested tags filled in"/>
  <img src="screenshots/add-location.png" width="200" alt="Map picker with live place search"/>
  <img src="screenshots/profile.png" width="200" alt="Profile with statistics and data export"/>
</div>

In order: the list; natural-language search, where `art` returns SFMOMA rather than
*T-**art**-ine Bakery*; a place with its notes; the Smart Summary written from those
notes; tag suggestions on a place being created; the map picker's live place search;
and the profile, with stats and JSON export.
